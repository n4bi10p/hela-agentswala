...
export default function Home() {
  // Different animation types per section
  const heroRef = useScrollAnimation({ type: 'blur-in', delay: 100 });
  const howItWorksRef = useScrollAnimation({ type: 'stagger', staggerDelay: 120 });
  const aboutRef = useScrollAnimation({ type: 'fade-up', delay: 0 });
  const aboutCardsRef = useScrollAnimation({ type: 'stagger', staggerDelay: 100 });
  const pricingRef = useScrollAnimation({ type: 'fade-up' });
  const pricingGridRef = useScrollAnimation({ type: 'stagger', staggerDelay: 80 });
  const faqRef = useScrollAnimation({ type: 'fade-left' });
  const faqItemsRef = useScrollAnimation({ type: 'stagger', staggerDelay: 90 });
  const roadmapRef = useScrollAnimation({ type: 'fade-right' });
  const roadmapItemsRef = useScrollAnimation({ type: 'stagger', staggerDelay: 100 });
  const statsRef = useScrollAnimation({ type: 'scale-up' });
  const developerRef = useScrollAnimation({ type: 'blur-in', delay: 100 });
  const footerRef = useScrollAnimation({ type: 'fade-up', delay: 50 });

  // Parallax backgrounds
  const heroParallaxRef = useParallax(0.15);
  const devParallaxRef = useParallax(-0.1);
  ...
  return (
    <main className="min-h-screen bg-black">
      ...
      <section ref={heroRef} className="relative min-h-screen flex flex-col items-center justify-center border-b border-white/12 pt-24 overflow-hidden">
        {/* Parallax blur backgrounds */}
        <div ref={heroParallaxRef as React.RefObject<HTMLDivElement>} className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 left-1/3 w-96 h-96 bg-white/5 rounded-full blur-3xl float-anim"></div>
          <div className="absolute bottom-20 right-1/3 w-96 h-96 bg-white/5 rounded-full blur-3xl float-anim" style={{ animationDelay: '2s' }}></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col items-center gap-4 animate-[fadeInUp_0.8s_ease-out_0.4s_both]">
            <Link href="/marketplace" className="bg-primary text-black px-12 py-4 font-headline text-2xl hover:bg-black hover:text-primary border border-primary transition-all duration-300 flex items-center gap-4 uppercase hover:shadow-lg hover:shadow-primary/50 glitch-hover glow-effect">[ START NOW ↗ ]</Link>
            <div className="font-mono text-white/30 text-xs tracking-[0.5em] scroll-indicator"></div>
          </div>
        </div>
        ...
        <div className="absolute bottom-12 right-8 bg-white text-black p-6 flex flex-col gap-2 min-w-[240px] hover:shadow-lg hover:shadow-white/20 transition-all duration-300 scanline-effect">
      ...
      <section ref={howItWorksRef} className="grid grid-cols-1 md:grid-cols-3 border-b border-white/12 bg-black relative">
        ...
        {[
          ...
          <div key={idx} data-stagger-child className={`p-12 flex flex-col gap-8 ${idx < 2 ? "border-b md:border-b-0 md:border-r" : ""} border-white/12 relative group hover:bg-white/5 transition-all duration-300 border-draw`}>
      ...
      <section ref={aboutRef} className="bg-black border-b border-white/12 px-8 py-24">
        <div className="max-w-4xl mx-auto">
          ...
          <div ref={aboutCardsRef as React.RefObject<HTMLDivElement>} className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div data-stagger-child className="border border-white/20 p-8 hover:border-white/60 transition-all duration-300 group hover:bg-white/5 scanline-effect">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="border border-white/20 p-6 hover:border-white/60 transition-all duration-300 group hover:bg-white/5 border-draw">
      ...
      <section ref={pricingRef} className="bg-black border-b border-white/12 px-8 py-24 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div ref={pricingGridRef as React.RefObject<HTMLDivElement>} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={idx} data-stagger-child className="border border-white/20 p-6 hover:border-white/60 transition-all duration-300 group hover:bg-white/5 backdrop-blur-sm relative glow-effect">
      ...
      <section ref={faqRef} className="bg-black border-b border-white/12 px-8 py-24">
        <div className="max-w-4xl mx-auto">
          ...
          <div ref={faqItemsRef as React.RefObject<HTMLDivElement>} className="space-y-4">
            {[
              ...
              <div key={i} data-stagger-child className="border border-white/20 p-4 hover:border-white/60 transition-all duration-300 group hover:bg-white/5 border-draw">
      ...
      <section ref={roadmapRef} className="bg-black border-b border-white/12 px-8 py-24">
        <div className="max-w-4xl mx-auto">
          ...
          <div ref={roadmapItemsRef as React.RefObject<HTMLDivElement>} className="space-y-6">
            {[
              ...
              <div key={i} data-stagger-child className="border border-white/20 p-6 hover:border-white/60 transition-all duration-300 group hover:bg-white/5 glow-effect">
      ...
      <section ref={developerRef} className="p-8 md:p-24 bg-black border-t border-white/12 relative overflow-hidden">
        {/* Parallax blur effect backgrounds */}
        <div ref={devParallaxRef as React.RefObject<HTMLDivElement>} className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-white/5 rounded-full blur-3xl float-anim"></div>
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-white/5 rounded-full blur-3xl float-anim" style={{ animationDelay: '1.5s' }}></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center text-center gap-8">
          <div className="font-headline text-4xl md:text-5xl border border-white/20 px-6 py-2 text-white hover:border-white/60 hover:bg-white/5 transition-all duration-300 glitch-hover">[ FOR DEVELOPERS ↗ ]</div>
